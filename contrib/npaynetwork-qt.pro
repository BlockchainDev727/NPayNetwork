...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/npaynetwork-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/npaynetwork-cli.cpp \
           src/npaynetwork-tx.cpp \
           src/npaynetwork.cpp \
           src/db.cpp \
           ...
           src/qt/npaynetwork.cpp \
           src/qt/npaynetworkstrings.cpp \
...
RESOURCES += src/qt/npaynetwork.qrc src/qt/npaynetwork_locale.qrc

TRANSLATIONS += src/qt/locale/npaynetwork_bg.ts \
                src/qt/locale/npaynetwork_de.ts \
                src/qt/locale/npaynetwork_en.ts \
                src/qt/locale/npaynetwork_es.ts \
                src/qt/locale/npaynetwork_fi.ts \
                src/qt/locale/npaynetwork_fr.ts \
                src/qt/locale/npaynetwork_it.ts \
                src/qt/locale/npaynetwork_ja.ts \
                src/qt/locale/npaynetwork_pl.ts \
                src/qt/locale/npaynetwork_pt.ts \
                src/qt/locale/npaynetwork_ru.ts \
                src/qt/locale/npaynetwork_sk.ts \
                src/qt/locale/npaynetwork_sv.ts \
                src/qt/locale/npaynetwork_vi.ts \
                src/qt/locale/npaynetwork_zh_CN.ts \
                src/qt/locale/npaynetwork_zh_TW.ts
