...
/** Utility functions used by the NPAYNETWORK Qt UI.
 */
namespace GUIUtil
{
...
// Render NPAYNETWORK addresses in monospace font
...
// Parse "npaynetwork:" URI into recipient object, return true on successful parsing
