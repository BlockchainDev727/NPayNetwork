...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("NPAYNETWORK Core"),
     ...
     * override -datadir in the npaynetwork.conf file in the default data directory
     * (to be consistent with npaynetworkd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
