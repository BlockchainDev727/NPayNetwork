                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NPAYNETWORK Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NPAYNETWORK address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and npaynetwork: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zNPAY"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NPAYNETWORK Core"), this);
    aboutAction->setStatusTip(tr("Show information about NPAYNETWORK Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NPAYNETWORK"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NPAYNETWORK addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NPAYNETWORK addresses"));
    ...
    openAction->setStatusTip(tr("Open a NPAYNETWORK: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NPAYNETWORK Core help message to get a list with possible NPAYNETWORK command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NPAYNETWORK Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NPAYNETWORK network", "", count));
}
...
{
    QString strTitle = tr("NPAYNETWORK Core"); // default title
