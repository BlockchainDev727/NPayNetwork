...
public:
    ...
    void setZNPayControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzNPAY_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzNPAY_clicked();
    void on_pushButtonZNPayControl_clicked();
