...
// Copyright (c) 2016-2018 The NPAYNETWORK developers
...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("NPAY Stake");
    case TransactionRecord::StakeZNPAY:
        return tr("zNPAY Stake");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted NPAY to zNPAY");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zNPAY");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received NPAY from zNPAY");
    case TransactionRecord::ZerocoinSpend_Change_zNPay:
        return tr("Minted Change as zNPAY from zNPAY Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zNPAY to NPAY");
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord* wtx, bool tooltip) const
{
    ...
    case TransactionRecord::ZerocoinMint:
    case TransactionRecord::ZerocoinSpend_Change_zNPay:
        return tr("Anonymous (zNPAY Transaction)");
    case TransactionRecord::StakeZNPAY:
        return tr("Anonymous (zNPAY Stake)");
    case TransactionRecord::SendToSelf:
    default:
