                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzNPAYPathCustom = GetArg("-znpaybackuppath", "");
    ...
    if(!strzNPAYPathCustom.empty()) {
        ui->wallet_customznpaybackuppath->setText(QString::fromStdString(strzNPAYPathCustom));
        ui->wallet_customznpaybackuppath_label->setVisible(true);
        ui->wallet_customznpaybackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzNPAYPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the NPAYNETWORK RPC console.") + "<br>" +
