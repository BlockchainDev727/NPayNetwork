...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NPayNetwork Core npaynetwork-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  npaynetwork-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded npaynetwork transaction") + "\n" +
                               "  npaynetwork-tx [options] -create [commands]   " + _("Create hex-encoded npaynetwork transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded npaynetwork transaction
