...
/**
 * NPAYNETWORK RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setznpayseed(const UniValue& params, bool fHelp);
extern UniValue getznpayseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdznpay(const UniValue& params, bool fHelp);
extern UniValue dznpaystate(const UniValue& params, bool fHelp);
