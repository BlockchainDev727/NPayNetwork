...
#   c) node1 mines 32 blocks, so now node 0 has 60001npay, node 1 has 4250npay, node2 has none.
#   d) node0 sends 601 npay to node2, in two transactions (301 npay, then 300 npay).
