...
In order to support loading of multiple wallets in npaynetwork-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is npaynetwork.cpp.
...
Changes to npaynetwork.cpp
----------------------
npaynetwork.cpp is the entry point into npaynetwork-qt, and as such, will require some minor modifications to provide hooks for
