Contributing to NPAYNETWORK Core
============================

The NPAYNETWORK Core project operates an open contributor model where anyone is
...
The following applies to code changes to the NPAYNETWORK Core project, and is not to be
confused with overall NPAYNETWORK Network Protocol consensus changes.

Whether a pull request is merged into NPAYNETWORK Core rests with the project merge
...
Patches that change NPAYNETWORK consensus rules are considerably more involved than
...
Where a patch set proposes to change the NPAYNETWORK consensus, it must have been
...
The project leader is the release manager for each NPAYNETWORK Core release.
